...
public class TopNewsHeadlines implements Feature {
	/**
	 * The return string containing the title, author, and URL of top news headlines
	 * for the day
	 */
	private String headlines;

	/**
	 * Constructs a new TopNewsHeadlines object. Instantiates the headlines string
	 * and calls parseQuery()
	 * 
	 ...
	 * 
	 * @return Response The top headlines for the day
	 */
	@Override
	 ...
	 * 
	 * @throws IOException If the API cannot function properly
	 */
	 ...
	 * 
	 * @param response The JSON string retrieved from getHeadlines()
	 */
