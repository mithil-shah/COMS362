...
public class UnsplashSearch implements Feature
{
	...
	/**
	 * Constructs a new UnsplashSearch object where variables above are initialized, query is parsed, and then images are retrieved
	 * 
	 * @param query
	...
	/**
	 * Retrieves images based off the topic specified by the user and the number of images specified by the user
	 * 
	 * @param toSearch
	...
	{
		String searchUrl = "https://api.unsplash.com/search/photos?page=1&per_page=" + numberOfPics + "&query=" + toSearch + "&client_id=84023d7dd975661fbade252d0a70f9bb401be3af6d272c7913c4cd2c66c13524";
	 ...
	 * 
	 * @param response
	 * 		The JSON string retrieved in getImages()
	 */
	 ...
	 * 
	 * @param paths
	 * 		The paths of the images found in parseJSON()
	 */
	...
	public void parseQuery(String query) 
	{
        ...
        //Gets the search term provided by the user by avoiding all words in the nonKeywords string.
